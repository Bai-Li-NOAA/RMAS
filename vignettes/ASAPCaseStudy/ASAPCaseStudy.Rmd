...
# recruitment$sigma_r$estimated <- TRUE # ASAP fix it
...
survey_num <- 1 # How to set survey empirical weight-at-age for more than 1 survey? And add the information to growth$SetUndifferentiatedSurveyWeight and population$SetGrowth
...
#population$sex_ratio <- 1 Is the default sex_ratio is 0.5? Can we have other options?
...
asap$survey <- asap_output$index.pred$ind0
