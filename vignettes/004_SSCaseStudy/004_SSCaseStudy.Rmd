...
- SS uses real ages in weight-at-age data, but age group in age composition data. How to set up ages in RMAS in this situation? 

- There are missing data in inputs (e.g., survey index and age composition).  How to set up survey in RMAS with missing data? 